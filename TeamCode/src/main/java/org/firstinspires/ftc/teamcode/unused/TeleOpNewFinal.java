...
@TeleOp(name="TeleOpNewFinal Version Fake", group="Iterative Opmode")
@Disabled
public class TeleOpNewFinal extends OpMode
{
...
*/
    ...
    public void loop() {
        ...
        if(gamepad2.left_stick_y > 0.0) {
            ...
            armMotor.setPower(armspeed);//*gamepad2.left_stick_y);
        ...
        */
        ...
        /*
        //raises turn servo to drop cargo in lower goal
        if(gamepad2.a) {
